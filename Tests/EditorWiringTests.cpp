...
public:
    ...
    void runTest() override
    {
        ...
        beginTest ("This panel READS the shared header part, rather than agreeing with it");
        {
            ...
            expectEquals ((int) L::lcdRowY, nf::HeaderGeometry::bandY);
            expectEquals ((int) L::lcdRowH, nf::HeaderGeometry::bandH);
            expectEquals ((int) L::programX, nf::HeaderGeometry::lcdX);
            expectEquals ((int) L::programW, nf::HeaderGeometry::lcdW);
            expectEquals ((int) L::saveX, nf::HeaderGeometry::saveX);
            expectEquals ((int) L::saveW, nf::HeaderGeometry::saveW);
            expectEquals ((int) L::deleteX, nf::HeaderGeometry::deleteX);
            expectEquals ((int) L::deleteW, nf::HeaderGeometry::deleteW);
            ...
            expectEquals ((int) L::canvasHeight, 660);
        }
...
public:
    ...
    void runTest() override
    {
        beginTest ("The shipping processor cannot reach the user's real Programs directory");
        {
            ...
            ElmerAudioProcessor processor;
            const auto used = processor.programs.getUserProgramDirectory();
