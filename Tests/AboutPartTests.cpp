...
public:
    ...
    void runTest() override
    {
        ...
        auto* editor = dynamic_cast<ElmerAudioProcessorEditor*> (processor.createEditor());
        ...
        expect (nf::AboutBox::repositoryFits ("github.com/trudslev/elmer-audio-plugin"),
        ...
        expect (nf::testing::writeComponentPng (*content, dir.getChildFile ("elmer-rest.png")),
        ...
        expect (nf::testing::writeComponentPng (*content, dir.getChildFile ("elmer-about.png")),
